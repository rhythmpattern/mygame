...
Trigger_SoundNotify::Trigger_SoundNotify(Character* source,
                                     double      range):Trigger_LimitedLifetime<Character>(FrameRate /10),
...
//-----------------------------------------------------------------------------
void Trigger_SoundNotify::Try(Character* pBot)
{
