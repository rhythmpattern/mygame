...
//------------------------------- ctor ----------------------------------------
//-----------------------------------------------------------------------------
 SensoryMemory:: SensoryMemory(Character* owner,
...
//-----------------------------------------------------------------------------
void SensoryMemory::RemoveBotFromMemory(Character* pBot)
{
...
//-----------------------------------------------------------------------------
double  SensoryMemory::GetTimeOpponentHasBeenVisible(Character* pOpponent)const
{
  MemoryMap::const_iterator it = m_MemoryMap.find(pOpponent);
...
//-----------------------------------------------------------------------------
double SensoryMemory::GetTimeOpponentHasBeenOutOfView(Character* pOpponent)const
{
  MemoryMap::const_iterator it = m_MemoryMap.find(pOpponent);
...
//  returns the amount of time the given bot has been visible
//-----------------------------------------------------------------------------
double  SensoryMemory::GetTimeSinceLastSensed(Character* pOpponent)const
{
  MemoryMap::const_iterator it = m_MemoryMap.find(pOpponent);
