...
//------------------------------------------------------------------------
//
//  Name:   PlayerSteering.h
//
//  Desc:   class to encapsulate steering behaviors for the playable character
//
//  Author: Shaun Hose
//
//------------------------------------------------------------------------
...
private:
  ...
  Character*     m_pTargetAgent1;
  Character*     m_pTargetAgent2;
  ...
  //Arrive makes use of these to determine how quickly a Character
  ...
  Vector2D Separation(const std::vector<Character*> &agents);
...
public:
  ...
  PlayerSteering(Game* world, Player* agent);

  virtual ~PlayerSteering();

  //calculates and sums the steering forces from any active behaviors
  Vector2D Calculate();

  //calculates the component of the steering force that is parallel
  //with the Character heading
  ...
  void      SetTargetAgent1(Character* Agent){m_pTargetAgent1 = Agent;}
  void      SetTargetAgent2(Character* Agent){m_pTargetAgent2 = Agent;}
