...
bool StateParser::parseState(const char *stateFile, string stateID, vector<Entity *> *pObjects, std::vector<std::string> *pTextureIDs)
{
...
void StateParser::parseTextures(TiXmlElement* pStateRoot, std::vector<std::string> *pTextureIDs)
{
    ...
    for(TiXmlElement* e = pStateRoot->FirstChildElement(); e != NULL; e = e->NextSiblingElement())
    {
        ...
        TheTextureManager::Instance()->load(filenameAttribute, idAttribute, Game::Instance()->getRenderer());
    }
}

void StateParser::parseObjects(TiXmlElement *pStateRoot, std::vector<Entity *> *pObjects)
{
    for(TiXmlElement* e = pStateRoot->FirstChildElement(); e != NULL; e = e->NextSiblingElement())
    {
