...
protected:
  ...
  virtual void  InitializeFuzzyModule() {};
...
public:
  ...
  Weapon(unsigned int TypeOfGun,
               ...
               Character*   OwnerOfGun):m_iType(TypeOfGun),
...
inline void Weapon::ShootAt(Vector2D pos) {}
inline double GetDesirability(double DistToTarget) { return 1;}
