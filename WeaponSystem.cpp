...
//------------------------- ctor ----------------------------------------------
//-----------------------------------------------------------------------------
WeaponSystem::WeaponSystem(Character* owner,
                                       double ReactionTime,
                                       double AimAccuracy,
...
//  rads
//-----------------------------------------------------------------------------
void WeaponSystem::AddNoiseToAim(Vector2D& AimingPos)const
{
...
//  behavior.
//-----------------------------------------------------------------------------
Vector2D WeaponSystem::PredictFuturePositionOfTarget()const
{
...
//-----------------------------------------------------------------------------
void WeaponSystem::ShootAt(Vector2D pos)const
{
